...
Welcome to the dAPP-staking project! This repository contains instructions for interacting with the smart contracts and deploying the DApp.

## Overview of Staking DApp

The dAPP-staking is a decentralized application that enables users to stake ERC20 tokens into the platform and earn rewards. The staking process generates reward tokens per second, rewarding users based on their staked amount and duration.

![Homepage Screenshot](https://github.com/siddharthharshraj/dAPP-staking/raw/main/client/src/assets/homepage.png)
...
## For any questions or inquiries, feel free to reach out to [sid__web3] at [https://x.com/sid__web3].
